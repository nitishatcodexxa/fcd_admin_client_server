...
<Paper sx={{display:'flex',flexDirection:{xs:'column',sm:'row',md:'row'},height:50,justifyContent:'space-between'}}>
...
<Box sx={{display:'flex',flexDirection:{xs:'row',sm:'row',md:'row'},mr:2,ml:2}}>
